...
SCHEMA: Dict[str, Dict[str, Any]] = {
    ...
    "brain_switch":   {"slots": {"to": (str, 2, 20)}, "confirm": False, "early": False, "internal": True},
    "brain_big":      {"slots": {"on": (str, 2, 3)}, "confirm": False, "early": False, "internal": True},
    "brain_info":     {"slots": {}, "confirm": False, "early": False, "internal": True},
