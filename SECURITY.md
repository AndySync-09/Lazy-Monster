...
- **Seeing the screen.** Only when you ask a question about it. The front window's text and a screenshot of that window are sent to your chosen brain for that one answer and never saved to disk; windows that look private (passwords, recovery codes, keys, banking) are refused before anything is captured.
